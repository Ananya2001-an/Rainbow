...
const theme = extendTheme({
  colors: {
    ...
    purple: {
      900: tinycolor('#8B5CF6').darken(4).toString(),
      800: tinycolor('#8B5CF6').darken(0).toString(),
      700: tinycolor('#8B5CF6').lighten(8).toString(),
      600: tinycolor('#8B5CF6').lighten(16).toString(),
      500: tinycolor('#8B5CF6').lighten(32).toString(),
      400: tinycolor('#8B5CF6').lighten(40).toString(),
      300: tinycolor('#8B5CF6').lighten(56).toString(),
      200: tinycolor('#8B5CF6').lighten(64).toString(),
      100: tinycolor('#8B5CF6').lighten(80).toString(),
  },
  }
});
